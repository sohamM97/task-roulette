...
void main() {
  ...
  // Removed group: "Today's 5 new set preserves done tasks".
  // The _generateNewSet auto-pick logic has been replaced with a manual-only
  // model — pins are user-driven, so there is no "new set" regeneration to
  // simulate.
