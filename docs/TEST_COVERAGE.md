...
~1086 tests across 28 test files. Models and data layer are well-covered. Task card at 100%. Screens and services have significant gaps but firestore_service now has HTTP-mocked tests.
