...
### Services (minimal)
- **test/services/notification_service_test.dart** (11 tests) — `nextEightAM` (before/after/at 8 AM, midnight, month/year rollover, DST spring-forward, timezone preservation), `onNotificationTap` callback (null default, set and invoke).
